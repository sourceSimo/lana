...
if not redis:get(lana..'Times:'..msg.sender_user_id_) then
redis:setex(lana..'Times:'..msg.sender_user_id_,300,true)
...
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/lanaTELEE/lana.github.io/GetVersion.txt') or 0
...
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : ](t.me/znznn)',nil,inline,msg.id_)
return false
end
...
elseif Text== "اونلاين" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/M0000")
elseif Text== "احمد" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس لانا 😍](t.me/M0000")
elseif Text== "لانا" then return sendMsg(msg.chat_id_,msg.id_,"[مطور الردود والكلايش 😍](t.me/lana_200")
elseif Text== "اونلاين" then return sendMsg(msg.chat_id_,msg.id_,"[مطور كلايش 😍](t.me/M0000")
