...
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@Znznn&user_id="..msg.sender_user_id_);
if res ~= 200 then
end
...
if not MsgText[2] and msg.reply_id then
if redis:get(lana..'lock:babak:'..msg.chat_id_) == 'off' then
...
if redis:get(lana..'lock:babak:'..msg.chat_id_) == 'on' then
...
if not msg.Creator then return "👨🏻‍💻*¦* {المنشئ,المطور} فقط" end
redis:setex(lana..'rulse:wittingg'..msg.sender_user_id_,300,true)
return '📮┇حسننا عزيزي  📌\n🗯┇الان ارسل رابط  للمجموعه ☑️'
end

if MsgText[1] == "الرابط" then
if not redis:get(lana..'rulse:msgg'..msg.chat_id_) then 
return "📮*┇* اوه 📌 لا يوجد رابط ☹️\n🔖*┇*لانشاء رابط ارسل { ضع رابط او انشاء رابط } ☑️" 
else 
return "*🔖┇رابط المجموعة 💯 :*\n"..redis:get(lana..'rulse:msgg'..msg.chat_id_) 
end 
end
...
redis:del(lana..'rulse:msgg'..msg.chat_id_)
...
return '☎️*┇*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(lana..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
🛰️┊[اضغط هنا دخول لقتاة سورس ](t.me/Znznn) •
...
if not msg.SudoUser then return "👨🏻‍💻*┇* لـلـمـطـور فـقـط" end
return '⏺️*┊*عدد المشتركين في البوت : `'..redis:scard(lana..'users')..'` \n📡'
end
...
if not msg.SudoBase then return "👨🏻‍💻*┇* لـلـمـطـور الاسـاسـي فـقـط" end
local GetVerison = https.request('https://github.com/lanasTeam/lana.github.io/GetVersion.txt') or 0
...
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : لانا](t.me/Znznn)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 📊" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"👨🏻‍💻*┇* لـلـمـطـور الاسـاسـي فـقـط" end
return '📑┊الاحصائيات 📮 \n\n📤*┊*عدد الكروبات المفعله : '..redis:scard(lana..'group:ids')..'\n📈*┊*عدد المشتركين في البوت : '..redis:scard(lana..'users')..'\n📡'
end
---------------[End Function data] -----------------------
...
redis:set(lana..''..msg.chat_id_,true)  
...
return [[
📡┇اهلا بك في سورس لانا 

📯┇Source Lana

🔎┇[قناه السورس](t.me/Znznn) 

👮‍♂️┇[مطور السورس](t.me/Lana_200)

🔋┇[كليشه التنصيب](https://t.me/ZnZnn) 


📮┇[لــ تواصل](t.me/M0000)
...
text = [[⚜┊اهلا انآ بوت آسـمـي   []]..redis:get(lana..':NameBot:')..[[] 🎖
📮┊آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📈┊مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
if redis:get(lana..'rulse:wittingg'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(lana..'rulse:wittingg'..msg.sender_user_id_) 
redis:set(lana..'rulse:msgg'..msg.chat_id_,Flter_Markdown(msg.text)) 
...
if msg.photo and redis:get(lana..'welcom_ph:witting'..msg.sender_user_id_) then
...
local NUM_MSG_MAX = (redis:get(lana..'num_msg_lana'..msg.chat_id_) or 5)
...
elseif msg.edited and redis:get(lana..'lock_edit'..msg.chat_id_) then -- قفل الميديا
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif Text== "مطور لانا" or Text== "مطور السورس" or Text== "مطور سورس" or Text=="مطور بوتات" or Text=="سجاد مطور سورس لانا" then
return sendMsg(msg.chat_id_,msg.id_,"[اضغط هنا لدخول لمطور سورس ](t.me/Znznn) " )
