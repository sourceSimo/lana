...
🛰️┊[اضغط هنا دخول لقناة ](t.me/znznn) •
...
sendMsg(msg.chat_id_,msg.id_,'📛*┇* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع الُسِوَرَسِ يرجى  تعديل ع الاسم\n💥')
end  
else
...
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : الاخوين](t.me/znznn)',nil,inline,msg.id_)
return false
end
